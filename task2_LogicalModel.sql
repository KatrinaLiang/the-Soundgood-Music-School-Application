...
ALTER TABLE instruments_instructor ADD CONSTRAINT PK_instruments_instructor PRIMARY KEY (instrument_id,employment_id);
...
ALTER TABLE student_lesson ADD CONSTRAINT PK_student_lesson PRIMARY KEY (student_id,group_lesson_id);
...
ALTER TABLE ensemble ADD CONSTRAINT PK_ensemble PRIMARY KEY (ensemble_id,group_lesson_id);
...
ALTER TABLE ensemble_instrument ADD CONSTRAINT PK_ensemble_instrument PRIMARY KEY (instrument_id,ensemble_id,group_lesson_id);
...
ALTER TABLE instructor_salary ADD CONSTRAINT FK_instructor_salary_0 FOREIGN KEY (price_id) REFERENCES salary_for_instructor (id);
ALTER TABLE instructor_salary ADD CONSTRAINT FK_instructor_salary_1 FOREIGN KEY (employment_id) REFERENCES instructor (employment_id);
...
ALTER TABLE instruments_instructor ADD CONSTRAINT FK_instruments_instructor_0 FOREIGN KEY (instrument_id) REFERENCES instrument (id);
ALTER TABLE instruments_instructor ADD CONSTRAINT FK_instruments_instructor_1 FOREIGN KEY (employment_id) REFERENCES instructor (employment_id);
...
ALTER TABLE individual_lesson ADD CONSTRAINT FK_individual_lesson_0 FOREIGN KEY (employment_id) REFERENCES instructor (employment_id);
...
ALTER TABLE student_lesson ADD CONSTRAINT FK_student_lesson_1 FOREIGN KEY (group_lesson_id) REFERENCES group_lesson (group_lesson_id);


ALTER TABLE ensemble ADD CONSTRAINT FK_ensemble_0 FOREIGN KEY (group_lesson_id) REFERENCES group_lesson (group_lesson_id);


ALTER TABLE ensemble_instrument ADD CONSTRAINT FK_ensemble_instrument_0 FOREIGN KEY (instrument_id) REFERENCES instrument (id);
ALTER TABLE ensemble_instrument ADD CONSTRAINT FK_ensemble_instrument_1 FOREIGN KEY (ensemble_id,group_lesson_id) REFERENCES ensemble (ensemble_id,group_lesson_id);
